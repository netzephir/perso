...
class CI_Smarty extends Smarty {
    ...
    function view($template_name, $noDisplay = false) {
        ...
        if ($noDisplay)
        	...
        	return parent::display($template_name);
    }
    
    function viewExist($template_name) {
		if (strpos($template_name, '.') === FALSE && strpos($template_name, ':') === FALSE) {
			$template_name .= '.tpl';
		}
		return file_exists(APPPATH.'views/'.$template_name);
    }
}